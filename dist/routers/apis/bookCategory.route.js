...
var BookCategoryRoute = /** @class */ (function (_super) {
    ...
    BookCategoryRoute.prototype.getAllBookCategory = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, bookCategory_model_1.BookCategoryModel.find({})];
                    case 1:
                        bookCategories = _a.sent();
    ...
    return BookCategoryRoute;
}(baseRoute_1.BaseRoute));
exports.default = new BookCategoryRoute().router;
//# sourceMappingURL=bookCategory.route.js.map