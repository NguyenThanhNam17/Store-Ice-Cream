            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, invoice_model_1.InvoiceModel.findOne({ _id: parseText.invoice_no })];
                    case 2:
                        invoice = _a.sent();
                        if (!invoice) {
                            throw error_1.ErrorHelper.recoredNotFound("invoice!");
                        }
                        return [4 /*yield*/, order_model_1.OrderModel.findById(invoice.orderId)];
                    case 3:
                        order = _a.sent();
                        if (!order) {
                            if (!invoice) {
                        ...
                        return [4 /*yield*/, user_model_1.UserModel.findById(invoice.userId)];
                    case 4:
                        user = _a.sent();
                        if (!user) {
...
exports.default = new WebhookRoute().router;
